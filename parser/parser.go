...
// one of the "assertion functions"
...
func (p *Parser) parseExpressionStatement() *ast.ExpressionStatement {
	...
	// pass the lowest possible precedence to parseExpression,
	// since we didn't parse anything yet and we can't compare precedences.
